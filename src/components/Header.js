    ...
    <Container>
      <Content>
        ...
        <Search>
          ...
          <SearchLogo> <BiSearchAlt2 /> </SearchLogo>
...
text-align: center;
display: none;  //This vanishes the component 
`;

const User = styled(NavList)` //This copies the style of NavList to User
  a > svg {
    width: 24px;
    border-radius: 50%;
  }
  ...
  &:hover { //Do the following on hover:
    ${SignOut} {    //Select the SignOut component 
      align-items: center;
      display: flex;
      justify-content: center;
    }
...
const Work = styled(User)`  //This copies the style of User to Work
